...
CREATE TABLE Team (
    ...
    Team_Logo VARCHAR(256) -- Consider moving this to a file server for better performance
);
...
CREATE TABLE Player (
	...
	Bowling_Style ENUM('Right_arm Fast', 'Left_arm Fast', 'Left_arm Spin', 'Right_arm Spin', 'None') NULL,
